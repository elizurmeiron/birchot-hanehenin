...
const slides = [
    ...
    <div class="cards-grid">
        ...
        <div class="card" style="border-right:4px solid var(--primary-light);">
            ...
            <div class="card-text">
                <strong>קביעת היחס בינינו לבינו</strong> – הוא המלך ואנחנו נתיניו. לא שותפים שווים, לא כוח עיוור – אלא מלך שיש לו קשר אישי עם כל נתין.<br><br>
    ...
    <div class="example-box">
        ...
        <strong>"...בורא פרי העץ"</strong> – ועכשיו, ברגע הזה, אני מחבר את הפרי הזה שבידי – לבוראו
        </p>
    </div>`
    },
    ...
    <div class="source-box">
        ...
        כשקובעים סעודה על לחם, ברכת "המוציא" פוטרת את רוב המאכלים שבסעודה – הדברים הבאים מחמת הסעודה ללפת את הפת (לתת טעם ללחם) או להשביע. חוץ מיין ופירות שאינם חלק עיקרי מהסעודה.
    </div>`
    },
    ...
    <div class="cards-grid">
        <div class="card">
            ...
            <div class="card-title">טפל שבא להטעים (לשפר את הטעם)</div>
    ...
    <div class="highlight-box success">
        ...
        אם שבע אבל <strong>עדיין נהנה מהטעם</strong> – כן מברך! למשל, אחרי ארוחה גדושה רואה קינוח מפתה ורוצה לטעום – מברך, כי הוא נהנה (פנה"ל ט, א). הגבול הוא "אכילה גסה" – מצב שבו נפשו קצה במזון ואינו נהנה ממנו עוד.
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <tr><td><strong>לפני</strong></td><td>מקום נקי</td><td>לברך רחוק מאשפה/ריח רע</td><td>להתרחק ארבע אמות (2 מטר). אם אי אפשר – אינו מברך כלל</td></tr>
    ...
    // שקף 27 - Seder Kadimuyot
    {
        ...
        section: "סדר ברכות",
        content: `
    <div class="slide-header">        <h1>סדר הבברכות</h1>
        <div class="subtitle">כשיש כמה מאכלים – מה מברכים קודם?</div>
    </div>

    <p>כשיש לפנינו מאכלים שונים שברכותיהם שונות, יש סדר לברכות. הסדר מבוסס על עיקרון: <strong>ברכה מבוררת (ספציפית) קודמת לברכה כללית</strong>.</p>
    ...
    <div class="section-title">כלל שני: חביב קודם – כשהברכות זהות</div>
    <p>כשיש שני מאכלים <strong>מאותה ברכה</strong> (למשל, שני פירות "העץ", או שני ירקות "האדמה") – מברכים קודם על <strong>החביב</strong>. כלל זה אינו חל כשהברכות שונות.</p>

    <div class="section-title">כלל שלישי: שבעת המינים – כשאין חביבות מובהקת</div>
    <p>כששני מאכלים <strong>ברכתם זהה</strong> ואין אחד מהם חביב במיוחד (אוהב את שניהם במידה שווה, או שאינו יודע מי חביב יותר) – פרי משבעת המינים קודם. הסדר בתוך שבעת המינים נקבע לפי <strong>הקרבה למילה "ארץ" בפסוק</strong> (ראו שקף הבא).</p>

    <div class="highlight-box">
        <div class="highlight-box-title">📌 לסיכום: היררכיית הכללים</div>
        <ol class="num-list">
            <li><strong>ברכות שונות</strong> → סולם "המגע אש" ה(מוציא), מ(זונות), ג(פן), ע(ץ), א(דמה), ש(הכל), ללא תלות בחביבות</li>
            <li><strong>ברכות זהות + חביב מובהק</strong> → החביב קודם</li>
            <li><strong>ברכות זהות + אין חביבות מובהקת</strong> → פרי משבעת המינים קודם</li>
        </ol>
    </div>`
    },
    // שקף 28 - Seven species
    {
        title: "סדר שבעת המינים",
        menu: "שבעת המינים",
        section: "סדר ברכות",
        content: `
    <div class="slide-header">        <h1>סדר בפירות משבעת המינים</h1>
    ...
    <p>סדר החשיבות בתוך שבעת המינים נקבע לפי <strong>הקרבה למילה "ארץ"</strong> בפסוק. המילה "ארץ" מופיעה <strong>פעמיים</strong>, ומין הקרוב יותר ל"ארץ" קודם לברכה – גם אם הוא שייך ל"ארץ" השנייה (ברכות מא, ב – רב המנונא):</p>

    <div class="highlight-box warning">
        <div class="highlight-box-title">⚠️ מתי הסדר הזה רלוונטי?</div>
        הסדר שלהלן חל <strong>רק כששני המאכלים ברכתם זהה</strong> (שני פירות "העץ") <strong>ואין חביבות מובהקת</strong>. אם הברכות שונות – חוזרים לסולם הבסיסי "המגע אש". אם יש פרי החביב עליו במיוחד – החביב קודם, גם אם השני משבעת המינים.
    </div>

    <div class="section-title">פירות העץ משבעת המינים</div>
    <div class="table-container">
        <table>
            <thead><tr><th>סדר</th><th>הפרי</th><th>מרחק מ"ארץ"</th></tr></thead>
            <tbody>
                <tr><td>1</td><td>🫒 <strong>זית</strong></td><td><strong>1 מ"ארץ" השנייה</strong></td></tr>
                <tr><td>2</td><td>🌴 <strong>תמר</strong> (דבש)</td><td>2 מ"ארץ" השנייה</td></tr>
                <tr><td>3</td><td>🍇 <strong>ענבים</strong></td><td>3 מ"ארץ" הראשונה</td></tr>
                <tr><td>4</td><td>🍈 <strong>תאנה</strong></td><td>4 מ"ארץ" הראשונה</td></tr>
                <tr><td>5</td><td>🍎 <strong>רימון</strong></td><td>5 מ"ארץ" הראשונה</td></tr>
            </tbody>
        </table>
    </div>
    <p style="font-size:0.95em;color:var(--text-muted)">הערה: ענבים בברכת "העץ" – רק כשאוכלים אותם כפרי. ביין ובמיץ ענבים – ברכת "הגפן" (לסולם הבסיסי שלה).</p>

    <div class="section-title">דגנים: חיטה ושעורה</div>
    <p>שניהם בברכת "מזונות" (או "המוציא" כלחם). כשיש את שניהם וברכתם זהה – <strong>חיטה קודמת לשעורה</strong>, על פי סדר הופעתם בפסוק.</p>
    ...
    <div class="example-box">
        <div class="example-label">💡 דוגמאות</div>
        <p><strong>תמר ותפוח</strong> (שניהם "העץ"):</p>
        <ul class="num-list">
            <li>אוהב את שניהם במידה שווה → <strong>תמר</strong> קודם (משבעת המינים, סדר 2 בתוך העץ)</li>
            <li>התפוח חביב עליו במיוחד → <strong>תפוח</strong> קודם (החביב גובר כשהברכות זהות)</li>
        </ul>
        <p><strong>תפוח (העץ) וגזר (האדמה)</strong>: סולם בסיסי קובע – תפוח קודם, גם אם הגזר חביב יותר וגם אם בכלל אין שם פרי משבעת המינים.</p>
    </div>
    ...
    <div class="source-box">
        ...
        <strong>"שומע כעונה"</strong> – השומע ברכה ומתכוון לצאת בה ידי חובה, כאילו אמרה בעצמו.<br>
        <strong>"גדול העונה אמן יותר מן המברך"</strong> (ברכות נג, ב) – אמן חותמת ומאשרת את הברכה, ובלעדיה הברכה אינה מושלמת. העונה זוכה הן בשכר הברכה (דרך שומע כעונה) הן בשכר עניית האמן.
    </div>`
    },
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <tr style="background:var(--correct-bg)"><td><strong>2. ברכת הארץ</strong></td><td>יהושע בן נון</td><td>כשאכלו לראשונה מתבואת הארץ (יהושע ה, יא: "מֵעֲבוּר הָאָרֶץ")</td><td>הודאה על <strong>המתנות הייחודיות</strong> של עם ישראל: ארץ ישראל, יציאת מצרים, ברית המילה, התורה</td></tr>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <tr>
                    <td>שבת</td>
                    <td colspan="2" style="text-align:center">"ורצה והחליצנו ביום השבת הזה"</td>
                </tr>
                <tr>
                    <td>ראש חודש</td>
                    <td colspan="2" style="text-align:center">"וזכרנו לטובה ביום ראש החודש הזה"</td>
                </tr>
                <tr>
                    <td>ראש השנה</td>
                    <td colspan="2" style="text-align:center">"וזכרנו לטובה ביום הזכרון הזה"</td>
                </tr>
                <tr>
                    <td>יום הכיפורים *</td>
                    <td colspan="2" style="text-align:center">"וזכרנו לטובה ביום הכיפורים הזה"</td>
                </tr>
                <tr>
                    <td>פסח</td>
                    <td>"ושמחנו ביום חג המצות הזה"</td>
                    <td>"ושמחנו ביום חג המצות הזה ביום (טוב) מקרא קודש הזה"</td>
                </tr>
                <tr>
                    <td>שבועות</td>
                    <td>"ושמחנו ביום חג השבועות הזה"</td>
                    <td>"ושמחנו ביום חג השבועות הזה ביום טוב מקרא קודש הזה"</td>
                </tr>
                <tr>
                    <td>סוכות / חוה"מ</td>
                    <td>"ושמחנו ביום חג הסוכות הזה"</td>
                    <td>"ושמחנו ביום חג הסוכות הזה ביום (טוב) מקרא קודש הזה"</td>
                </tr>
                <tr>
                    <td>שמיני עצרת / שמח"ת</td>
                    <td>"ושמחנו ביום השמיני חג העצרת הזה"</td>
                    <td>"ושמחנו ביום שמיני חג עצרת הזה ביום טוב מקרא קודש הזה"</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="source-box">
        ...
        ברכה מעין שלוש נתקנה מדרבנן כנגד שלוש ברכות של ברכת המזון. נוסחה מותאם לסוג המאכל: "על המחיה" – מזונות, "על העץ" – פירות שבה"מ, "על הגפן" – יין. ניתן לשלב נוסחים בברכה אחת. שכח תוספות שבת/יו"ט – אינו חוזר.
    </div>`
    },
    ...
    <div class="bracha-text">בָּרוּךְ אַתָּה יְהֹוָה, אֱלֹהֵֽינוּ מֶֽלֶךְ הָעוֹלָם, בּוֹרֵא נְפָשׁוֹת רַבּוֹת וְחֶסְרוֹנָן עַל כָּל־מַה־שֶּׁבָּרָֽאתָ לְהַחֲיוֹת בָּהֶם נֶֽפֶשׁ כָּל־חָי, בָּרוּךְ חַי הָעוֹלָמִים.
</div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <tr>
                    <td><strong>בּוֹרֵא נְפָשׁוֹת רַבּוֹת</strong></td>
                    <td>בורא יצורים חיים רבים ומגוונים – בני אדם, בעלי חיים, צמחים, כל חי</td>
                </tr>
                <tr>
                    <td><strong>וְחֶסְרוֹנָן</strong></td>
                    <td>ואת מחסורם – כלומר, את כל מה שדרוש להם כדי להתקיים: מזון, מים, אוויר. הקיום עצמו מותנה בהשלמה מתמדת מבחוץ, וה' ברא גם את הצורך וגם את מילויו</td>
                </tr>
                <tr>
                    <td><strong>עַל כָּל מַה שֶּׁבָּרָא</strong></td>
                    <td>לא רק על המאכל הזה ששימש אותי כעת, אלא על כל אוצר הבריאה כולה</td>
                </tr>
                <tr>
                    <td><strong>לְהַחֲיוֹת בָּהֶם נֶפֶשׁ כָּל חָי</strong></td>
                    <td>שתפקידם להחיות כל יצור – כל הבריאה ערוכה כך שתתמוך בחיים</td>
                </tr>
                <tr>
                    <td><strong>בָּרוּךְ חֵי הָעוֹלָמִים</strong></td>
                    <td>חתימה ייחודית. בניגוד לשאר ברכות הנהנין החותמות ב"ברוך אתה ה'...", כאן הנוסח הוא "ברוך חי העולמים" – ה' כמקור החיים הזורם בכל הדורות</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="highlight-box success">
        ...
        "בורא נפשות וחסרונן" – ברכה זו רחבה מכל הברכות האחרות: היא אינה על מאכל מסוים בלבד, אלא הודאה על עצם עיקרון הקיום – שה' ברא עולם שבו לכל יצור יש מה שהוא צריך. כשאוכלים תפוח ומברכים "בורא נפשות", מכירים בכך שה' לא רק ברא אותנו, אלא גם את הסביבה כולה שתספק את צרכינו.
    </div>
    ...
    <div class="cards-grid">
        ...
        <div class="card">
            ...
            <div class="card-text">שוקולד, סוכריות, במבה</div>
        </div>
    </div>
    ...
    <div class="example-box">
        ...
        <strong>הרב עובדיה יוסף</strong> (יביע אומר ה' או"ח יז): <strong>בורא נפשות קודם</strong>, כי חושש שמעין שלוש תפטור גם את הירקות בניסוח "ועל תנובת השדה".<br><br>
    ...
    <div class="source-box">
        ...
        "בורא נפשות רבות וחסרונן" – הודאה על כל הדברים שה' ברא לקיום החיים. מברכים לאחר כזית מאכל או רביעית משקה, עד ~72 דקות. בורא נפשות ניתנת לאמירה בכל מקום (שו"ע קעח). כשיש גם מעין שלוש – מחלוקת בסדר: מ"ב – מעין שלוש קודם; הרב עובדיה יוסף – בורא נפשות קודם.
    </div>`
    },
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <tr><td>🍞 לחם</td><td><strong>המוציא</strong></td><td>אחרי נטילת ידיים. פוטר: חמאה, ריבה, ביצה, סלט</td></tr>
                <tr><td>🧈 חמאה וריבה</td><td><em>נפטרים</em></td><td>טפלים ללחם</td></tr>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <tr><td><strong>בורא מיני בשמים</strong></td><td>במקרה של ספק</td><td>כשמקור הריח אינו ידוע בדיוק, או שאינו נכנס לקטגוריות לעיל</td></tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="highlight-box">
        ...
        במקרה של ספק בין "עצי" ל"עשבי" או אם מוקר הריח מורכב מסוגים שונים – מברכים <strong>"מיני בשמים"</strong> שהיא כוללנית ופוטרת בדיעבד. אך לכתחילה יש לברר את מקור הריח ולברך את הברכה המדויקת.
    </div>
    ...
    <div class="two-cols">
        <div class="card" style="border-right:4px solid var(--accent)">
            <div class="card-title">❌ אין מברכים – הרב עובדיה יוסף</div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <tr><td><strong>וְקִיְּמָנוּ</strong></td><td>וקיים אותנו – שמר אותנו</td></tr>
                <tr><td><strong>וְהִגִּיעָנוּ לַזְּמַן הַזֶּה</strong></td><td>והביאנו עד לרגע הזה – זכינו להגיע לחוויה או למצווה הזו</td></tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <tr><td>יום כיפור</td><td>נשים אשכנזיות או נשים שלא הולכות לבית הכנסת - בהדלקת נרות, אחרים - בתחילת תפילת ערבית (לפני קול נדרי)</td><td>אין קידוש, לכן מברכים בתפילה</td></tr>
    ...
    <p>בחגים דאורייתא מברכים שהחיינו <em>גם</em> על עצם היום (בקידוש) <em>וגם</em> על מצוות החג. בחגים דרבנן – על המצוות בלבד, לא על היום:</p>
    <div class="table-container">
        <table>
            ...
            <tbody>
                <tr style="background:var(--correct-bg)">
                    ...
                    <td>בשני הימים (שו”ע רמ”א תר, ג; מ”ב ז)</td>
                    <td>ביום הראשון בלבד (שו"ע תקפה, א)</td>
                </tr>
                <tr style="background:var(--correct-bg)">
                    <td>🌿 <strong>נטילת לולב</strong> (דאורייתא)</td>
                    <td colspan="2" style="text-align:center">ביום הראשון בלבד (שו"ע תרמא, א)</td>
                </tr>
                <tr>
                    <td>🕎 <strong>נר חנוכה</strong> (דרבנן)</td>
                    <td colspan="2" style="text-align:center">לילה ראשון בלבד (שו"ע תרעו, א)</td>
                </tr>
                <tr>
                    <td>📜 <strong>קריאת מגילה</strong> (דרבנן)</td>
                    <td>בלילה <strong>ובבוקר</strong> – שתי קריאות, שתי ברכות (רמ"א, או"ח סי' תרצב סעי' א)</td>
                    <td>בלילה בלבד (שו"ע, או"ח סי' תרצב סעי' א)</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>רכב חדש</td>
                    <td colspan="2" style="text-align:center">⚖️ אם לעצמו – שהחיינו; אם משפחתי – הטוב והמטיב</td>
                </tr>
                <tr style="background:var(--warning-bg)">
                    <td>גרביים, תחתונים, כיפה</td>
                    <td colspan="2" style="text-align:center">❌ לא מברכים – אין שמחה מיוחדת</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="slide-header">
        ...
        <div class="subtitle">27 שאלות בנושא ברכות ראשונות – בדוק את עצמך!</div>
    </div>
    <div class="quiz-container">
        <div class="quiz-question">1. מה ברכת בננה?</div>
...
`
    ...
    <div class="slide-header">
        <h1>חידון – בדוק את עצמך!</h1>
        <div class="subtitle">25 שאלות בנושא ברכות אחרונות – בדוק את עצמך!</div>
    </div>
...
`
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc3">
            ✅ במקרה של ספק – "מיני בשמים" פוטרת הכל בדיעבד.
            <button class="ref-btn" onclick="goToSlide(40)">← ראה שקף 39</button>
        </div>
    </div>
