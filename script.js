...
// שקף 16 - Shinui Tzura + Kedarko
{
    ...
    <div class="two-cols">
        <div class="highlight-box success" style="margin:0;">
            ...
            <em>יוצא מן הכלל: פרי שדרך אכילתו בריסוק (כמו רסק תפוחים) – שומר על ברכתו גם אחרי ריסוק מלא, כי בעיני בני אדם הוא עדיין אותו פרי.</em>
        </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                <tr><td>✅ ריסוק קל</td><td>רסק תפוחים, מחית בננה</td><td>כברכתו – עדיין "תפוחים"</td></tr>
            </tbody>
        </table>
    </div>
...
// שקף 20 - HaMotzi as meal opener
{
    title: "המוציא – פותחת סעודה",
    menu: "המוציא (ג): פותחת סעודה",
    section: "ברכות ראשונות – ברכות מיוחדות",
    content: `
...
// שקף 21 - Flowchart deciding which bracha
{
...
// שקף 23 - Bracha she'eina tzricha
{
...
// שקף 25 - Unified first bracha rules
{
...
// שקף 28 - Shomea ke'oneh and Amen
{
...
// שקף 29 - Bracha Acharona overview
{
...
// שקף 34 - Bracha acharona flowchart
{
...
// שקף 35 - Last bracha rules (merged)
{
...
// שקף 36 - Daily examples: breakfast
{
...
// שקף 39 - Brachot on smell - principles
{
...
// שקף 40 - Brachot on smell - examples and disputes
{
...
// שקף 42 - SheHechianu - yamim tovim
{
...
// שקף 44 - SheHechianu - new garment and house
{
...
// שקף 45 - SheHechianu - seeing a friend
{
...
// שקף 46 - Quiz rishonot
{
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qa18">
            ...
            <button class="ref-btn" onclick="goToSlide(26)">← ראה שקף 26</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        <div class="quiz-question">21. ריסקת תפוח לרסק מלא – ברכתו "העץ" עדיין?</div>
        <div class="quiz-options">
            <button class="quiz-option" onclick="checkQuizQ(this, false, 'qa21')">לא, ל"שהכל"</button>
            <button class="quiz-option" onclick="checkQuizQ(this, true, 'qa21')">כן – דרך אכילתו ריסוק, הוא עדיין תפוח</button>
            <button class="quiz-option" onclick="checkQuizQ(this, false, 'qa21')">רק אם נשארו חלקיקים</button>
            <button class="quiz-option" onclick="checkQuizQ(this, false, 'qa21')">תלוי באחוז</button>
        </div>
        <div class="quiz-explanation" id="qa21">
            ✅ פרי שדרך אכילתו ריסוק שומר על ברכתו גם אחרי ריסוק מלא.
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qa24">
            ...
            <button class="ref-btn" onclick="goToSlide(24)">← ראה שקף 24</button>
        </div>
    </div>
...
// שקף 47 - Quiz acharonot
{
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qb1">
            ...
            <button class="ref-btn" onclick="goToSlide(30)">← ראה שקף 30</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qb2">
            ...
            <button class="ref-btn" onclick="goToSlide(32)">← ראה שקף 32</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qb3">
            ...
            <button class="ref-btn" onclick="goToSlide(33)">← ראה שקף 33</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qb7">
            ...
            <button class="ref-btn" onclick="goToSlide(29)">← ראה שקף 29</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qb9">
            ...
            <button class="ref-btn" onclick="goToSlide(34)">← ראה שקף 34</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qb10">
            ...
            <button class="ref-btn" onclick="goToSlide(35)">← ראה שקף 35</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qb16">
            ...
            <button class="ref-btn" onclick="goToSlide(31)">← ראה שקף 31</button>
        </div>
    </div>
...
// שקף 48 - Quiz nosafot
{
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc1">
            ...
            <button class="ref-btn" onclick="goToSlide(39)">← ראה שקף 39</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc2">
            ...
            <button class="ref-btn" onclick="goToSlide(40)">← ראה שקף 40</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc6">
            ...
            <button class="ref-btn" onclick="goToSlide(42)">← ראה שקף 42</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc11">
            ...
            <button class="ref-btn" onclick="goToSlide(43)">← ראה שקף 43</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc14">
            ...
            <button class="ref-btn" onclick="goToSlide(44)">← ראה שקף 44</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc18">
            ...
            <button class="ref-btn" onclick="goToSlide(45)">← ראה שקף 45</button>
        </div>
    </div>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-explanation" id="qc24">
            ...
            <button class="ref-btn" onclick="goToSlide(41)">← ראה שקף 41</button>
        </div>
    </div>
